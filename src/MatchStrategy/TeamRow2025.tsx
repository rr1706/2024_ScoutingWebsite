            ...
            <td className="text-center align-middle" style={{ backgroundColor: props.alliance === 'red' ? redColor : blueColor }}>
                {props.teamAverages?.successfulDeepClimb! > 0 ?
                    <Row>
                        ...
                        <Col className='text-start' style={{ fontSize: "10px", paddingLeft: 0, margin: 'auto' }}>({(props.teamAverages?.successfulDeepClimb! * props.teamAverages?.numMatches! / 100).toFixed(0)})</Col>
                    </Row>
                    :
                    <Row></Row>}
            </td>
