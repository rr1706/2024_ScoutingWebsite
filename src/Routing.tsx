...
import VerifyClimbs2025 from './VerifyMatchData/VerifyClimbs2025';
...
export default function routing() {
    return (
        <Routes>
            ...
            <Route path="/verifyclimbs" element={<Authorized authorized={< VerifyClimbs2025 />} notAuthorized={<Login />}></Authorized>} />
