            ...
            <Table>
                <thead>
                    <tr className="font-weight-bold">
                        ...
                        <td className="text-center align-middle" ><Button disabled={mode === allianceSelectionMode} className="btn btn-light" onClick={() => sortColumn("feedAvg")} > <b>Feeds</b></Button></td>
